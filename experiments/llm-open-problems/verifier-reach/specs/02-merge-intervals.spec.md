...
> The spec intentionally does NOT say whether intervals that merely *touch* at an endpoint
> (`[1,2]` and `[2,3]`) count as overlapping. That boundary rule is the non-inferable edge —
> see `../../README.md`.
